...
from drafts.gold_plots import price_per_m2_and_area,area_and_price_per_m2, negotiation, negotiate, avg_price_per_m2_district,select_from_silver, matrix, matrix_query
